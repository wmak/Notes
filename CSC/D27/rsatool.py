...
from pyasn1.type import univ  # added 10 Jul FAR
...
class RSA:
    ...
    def to_der(self):
        ...
        for x in [0, self.n, self.e, self.d, self.p, self.q, self.dP,
self.dQ, self.qInv]:
    ...
    def _dumpvar(self, var):
        ...
        parts = lambda s, l: '\n'.join([s[i:i+l] for i in xrange(0, len(s),
l)])
...
if __name__ == '__main__':
    ...
    parser.add_option('-e', dest='e', help='public exponent (default: %d)'
% DEFAULT_EXP, type='int', default=DEFAULT_EXP)
